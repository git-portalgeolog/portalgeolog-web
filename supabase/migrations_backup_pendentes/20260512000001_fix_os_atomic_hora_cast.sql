-- Corrige o cast da coluna hora na função update_os_atomic
-- A coluna hora em os_waypoints é do tipo time without time zone,
-- mas a função estava inserindo texto sem cast
